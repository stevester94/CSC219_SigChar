...
# Title: Top Block
# Generated: Sat Apr 27 22:13:16 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.analog_simple_squelch_cc_0, 0))
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.analog_frequency_modulator_fc_0, 0))

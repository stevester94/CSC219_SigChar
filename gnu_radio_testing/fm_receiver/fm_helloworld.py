...
# Title: Fm Helloworld
# Generated: Sat May  4 16:09:58 2019
##################################################
...
class fm_helloworld(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Fm Helloworld")
        ...
        self.usrp_freq = usrp_freq = 462.6e6
        ...
        # Connections
        ##################################################
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.wbfm_analog_receiver, 0))
        self.connect((self.fm_low_pass_filter, 0), (self.analog_simple_squelch_cc_0, 0))
        ...
        self.connect((self.volume_multiplier, 0), (self.audio_sink, 0))
